  ...
  return (
    <div className="relative w-full h-[260px] sm:h-[360px] lg:h-[500px]">
      ...
      <div className="absolute bottom-6 left-0 right-0 text-left text-white px-6 sm:px-8 lg:px-0 lg:right-auto lg:bottom-24 lg:left-20">
        ...
        <a
          href={ctaLink}
          className="inline-block bg-theme-surface hover:bg-theme-surface-subtle text-theme-heading font-semibold py-2.5 px-4 sm:py-3 sm:px-5 lg:py-4 lg:px-6 rounded-full text-sm lg:text-lg transition"
        >
          {cta}
        </a>
      </div>
