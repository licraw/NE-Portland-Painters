...
- **Back porch painting: $2,100**
- **Front porch floor preparation and painting: $400**
- **Recommended total customer price: $2,500**

The $2,100 back porch price remains unchanged. The $400 front porch floor add-on supports a full preparation-and-painting cycle for visible peeling/flaking coating and exposed wood: cleaning, scraping, feather-sanding, dust removal, spot priming, and two red floor finish coats. The combined $2,500 price uses the established $25 labor-cost basis and 29.4% markup convention.

## Pricing Audit Against Completed Estimates

| Metric | 7610 SE Harrison | 1707 SE Keanu | 5933 NE 31st Porch |
| --- | ---: | ---: | ---: |
| Customer price | $2,200 quoted; $2,270 final approved | $600 | $2,500 |
| Labor hours | 48 estimated, including 2 lock-install hours; 38 actual | 8 estimated; 16 actual | 48 estimated |
| Labor cost at $25/hr | $1,200 estimated; $950 actual | $200 estimated; $400 actual | $1,200 estimated |
| Material allowance | $500 estimated | $190 | $700 |
...
| Gross contribution / margin | $500 / 22.7% estimated; $981.88 / 43.3% actual | $210 / 35.0% estimated; about $10 / 1.7% using the $190 material allowance and actual labor, before overhead | $600 / 24.0% estimated |
| Effective price per labor hour | $45.83 estimated; $59.74 actual | $75.00 estimated; $37.50 actual | $52.08 estimated |
...
Crew assumption: **two painters for approximately 2-3 working days** if front porch preparation and coating proceed concurrently with back porch drying and recoating. Total active labor allowance: **48 hours**—40 back porch hours plus 8 front porch floor hours.
...
| Front porch spot priming | 1 | Prime exposed bare wood | $25 |
| Front porch floor finish coats | 3 | Two red porch-and-floor coats with edge work | $75 |
...
| **Total** | **48** | **Two painters, approximately 2-3 days with concurrent sequencing** | **$1,200** |

The schedule assumes coating-compatible weather, dry new lumber, normal recoat times, and uninterrupted access. Staging may shift by product cure requirements, especially for floor coating.

## Material and Sundry Allowance
...
| **Total material and sundry allowance** |  | **$700** | $600 back porch allowance + $100 front porch allowance |
...
Calculated Front Porch Price = $388.20
Rounded Front Porch Price = $400

Combined Direct Labor Cost = 48 hours x $25/hour = $1,200
Combined Material and Sundry Allowance = $700
Combined Direct Project Cost = $1,900
Combined Customer Price = $2,100 + $400 = $2,500
```

The combined price leaves **$600 above estimated direct cost**, or **24.0% of the customer price**. The front porch component leaves $100 above its $300 direct cost after rounding. This combined contribution covers overhead, contingency, and profit; the reference documents do not reliably split those categories.

## Production and Coating Notes

1. Confirm dimensions, stair count, and color boundaries before mobilization.
...
12. Apply two cream exterior finish coats to ceiling, posts, beams, braces, fascia, rails, and associated trim.
13. Complete minor touch-ups at new-to-existing junctions without expanding into existing-house repainting.
14. Demask, inspect, clean, label retained paint, and document final products/colors.

## Existing Fascia Constraint

The supplied photos show extensive peeling coating on existing fascia. That deteriorated fascia work is not part of the included front porch floor preparation. Existing fascia must be separately evaluated for substrate condition and replacement needs before scope or price is added.
...
- Front porch railings, columns, siding, trim, or carpentry; repair or replacement of split, loose, rotten, or structurally deteriorated porch boards.
- Hidden moisture damage or failed existing coatings discovered during normal preparation.
- Additional stairs, landings, rail components, interior/crawlspace faces, or other surfaces not shown in the supplied photos.
- Color changes after purchase, or extra coats required by a highly translucent selected color outside normal coverage.
- Weather or site-access delays beyond normal scheduling flexibility.

## Final Field Checklist

- Obtain the customer-approved color schedule.
