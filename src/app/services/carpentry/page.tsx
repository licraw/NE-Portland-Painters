...
import imageFiles from "@/app/gallery/carpentry/galleryFiles";
import { getBaseMetadata, siteConfig } from "@/lib/siteConfig";

export const metadata: Metadata = getBaseMetadata(
  siteConfig.carpentryService.title,
  siteConfig.carpentryService.metaDescription,
  "/services/carpentry"
);
    ...
    <>
      <div>
        ...
        >
          ...
          {siteConfig.carpentryService.intro.map((paragraph) => (
          ...
          <div className="pt-6">
            ...
            <p className="pt-4 text-sm text-theme-text-muted max-w-2xl">
              Fast, clear estimates for repairs and paint-ready carpentry. We’ll confirm scope, materials, and finish expectations before scheduling.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-8 pl-6 lg:pl-20 lg:pr-20 light-green-bg">
        <h2 className="font-sans font-medium text-3xl lg:text-4xl leading-[1.2] pb-6 text-center">
          {siteConfig.carpentryService.servicesHeading}
        </h2>
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-5">
          {siteConfig.carpentryService.services.slice(0, 6).map((service) => (
            <div
              key={service.title}
        ...
        <div className="max-w-5xl mx-auto pt-6">
          <details className="rounded-xl border border-theme-border bg-white/60 p-5">
            ...
            <ul className="list-disc list-inside pt-4 space-y-3 text-theme-text-muted">
              {siteConfig.carpentryService.services.slice(6).map((service) => (
      ...
      <div className="p-8 pl-6 lg:pl-20 lg:pr-20">
        ...
        <ol className="list-decimal list-inside space-y-2 text-theme-text-muted max-w-3xl">
          <li>Tell us what needs repair and your timing.</li>
          <li>We confirm scope, materials, and finish goals.</li>
      ...
      <div className="p-8 pl-6 lg:pl-20 lg:pr-20">
        <div className="rounded-2xl border border-theme-border bg-theme-surface-muted p-8 text-center">
          <h2 className="text-2xl lg:text-3xl font-semibold">
            {siteConfig.carpentryService.closingHeading}
          </h2>
          <p className="pt-3 text-theme-text-muted max-w-2xl mx-auto">
            {siteConfig.carpentryService.closingBody}
          </p>
